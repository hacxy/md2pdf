    ...
    <div className={styles.toolbar}>
      <div className={styles.brand}>
        <svg className={styles.logo} viewBox="0 0 28 28" fill="none">
          <rect x="2" y="1" width="18" height="26" rx="2.5" stroke="currentColor" strokeWidth="1.8" />
          ...
          <path d="M20 10l5 5-5 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.4" />
        </svg>
      ...
      <div className={styles.controls}>
        ...
        <button className={styles.secondaryBtn} onClick={onExportMarkdown} disabled={!hasContent} title="导出 Markdown">
        ...
        <button className={styles.secondaryBtn} onClick={() => onExport('print')} disabled={!hasContent} title="打印">
